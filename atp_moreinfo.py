from atp_ranking_progression import top_1000_historical, all_historical
...
for player, player_ts in all_historical.items():
    if player_ts['annual_best_rank'].min() <= 500 and player_ts.loc[0, 'ioc'] == 'IND' and player_ts['age'].max() >= 29:
