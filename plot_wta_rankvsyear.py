from wta_ranking_progression import top_1000_historical, all_historical, junior_historical
...
fig.suptitle('WTA ranking progression - Rank vs Year')
axes.set_xticks(range(2000, 2023, 5))
plt.savefig('figures_wta/rankvsyear.eps', dpi=1000)
...
axes.plot(range(15, 35), (100,)*len(range(15, 35)),
          '--', color='#E16671', linewidth=2)
formatting(axis=axes, xaxis='age')
fig.suptitle('WTA Ranking progression - Rank vs age')
axes.set_xticks(range(15, 37, 5))
plt.savefig('figures_wta/rankvsage.eps', dpi=1000)
...
fig.suptitle('WTA Performance over decades - Rank vs Age')
axes[0].set_title('Indian Women players')
axes[1].set_title('International Women players')
plt.subplots_adjust(top=0.8)
plt.savefig('figures_wta/PerformanceOverDecades.eps', dpi=1000)
...
axes.plot(range(15, 31), (100,)*len(range(15, 31)),
          '--', color='#E16671', linewidth=2)
formatting(axis=axes, label1='World Juniors', label2='India Juniors')
fig.suptitle('Junior girl champs in WTA ranking progression - Rank vs Age')
axes.set_xticks(range(15, 35, 5))
plt.savefig('figures_wta/juniorprogression.eps', dpi=1000)
